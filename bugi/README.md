...
|---|---|---|---|---|
| **BUG-024** | 2026-09-05 | Puste Obietnice Narzędzi bez Emisji XML i Amnezja Schematów w Trybie Resume (Podwójne Przerwanie Czatu na 0%) | 🚨 **Zdiagnozowany / Wymaga Poprawki w Proxy** | [`BUG-024_PROMISE_WITHOUT_TOOL_EXECUTION_RESUME_SCHEMA_AMNESIA.md`](file:///c:/Users/Ksawier/Pictures/Screenshots/Projekty_autorskie/deepseek-proxy-clean/bugi/BUG-024_PROMISE_WITHOUT_TOOL_EXECUTION_RESUME_SCHEMA_AMNESIA.md) |
...
Wszystkie poniższe błędy zostały deterministycznie naprawione w kodzie proxy (`server.py`, `monitor.py`), przetestowane suitą 65 testów jednostkowych (`pytest`) i zabezpieczone przed regresją:
